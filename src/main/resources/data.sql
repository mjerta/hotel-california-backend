...
VALUES
    ('2024-10-05 12:30:00', 'PREPARING_ORDER', 1, 1);
...
INSERT INTO Drinks (name, description, price, is_alcoholic, size, measurement, order_id)
VALUES ('Heineken', 'Licht en verfrissend bier', 3.75, TRUE, 500, 'ml',1);

INSERT INTO Drinks (name, description, price, is_alcoholic, size, measurement, order_id)
VALUES ('Chardonnay', 'Droge witte wijn', 4.50, TRUE, 150, 'ml', 1);

INSERT INTO Drinks (name, description, price, is_alcoholic, size, measurement, order_id)
VALUES ('Spa Blauw', 'Heerlijk zuiver bronwater', 2.00, FALSE, 500, 'ml',1 );

INSERT INTO Drinks (name, description, price, is_alcoholic, size, measurement, order_id)
VALUES ('Whisky', 'Pittige en rokerige smaak', 7.00, TRUE, 50, 'ml', 1);
